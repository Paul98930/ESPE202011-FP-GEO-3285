...
"  =============================================================================================");
                        ...
                        case 1:
                            do {
                                ...
                                switch(option){
                                    ...
                                    case 2: 
                                        GiveTheGradesMinutesSeconds(input);
                                        break;
                        ...
                        case 2:
                            do {
                                ...
                                switch(option){
                                    ...
                                    case 1: 
                                        transformateToLatitud(input);
                                        break;
                                                
                                    case 2: 
                                        transformateToLongitud(input);
                                        break;
    ...
    public static void giveTheArea3(Scanner input) {
        double px111;
        double px222;
        double px333;
        double px444;
    ...
    public static void giveTheArea2(Scanner input) {
        double px11;
        double px22;
        double px33;
        double px44;
    ...
    public static void giveTheArea(Scanner input) {
        double px1;
        double px2;
        double px3;
        double py1;
    ...
    public static void giveThePerimter(Scanner input) {
        double px111;
        double px222;
        double px333;
        double px444;
    ...
    public static void doTheArea(Scanner input) {
        double px11;
        double px22;
        double px33;
        double px44;
    ...
    public static void doThePerimeter(Scanner input) {
        double px1;
        double px2;
        double px3;
        double py1;
    ...
    public static void transformateToLongitud(Scanner input) {
        double longitud;
        double y;
    ...
    public static void transformateToLatitud(Scanner input) {
        double latitud;
        double x;
    ...
    public static void GiveTheGradesMinutesSeconds(Scanner input) {
        double grados1;
        double minutos1;
        double segundos1;
        double dd1;
    ...
    public static void changeGrades(Scanner input) {
        double grados;
        double minutos;
        double segundos;
        double dd;
